...
@pytest.mark.e2e
def test_v10_diagnostics_and_share_are_visible(page: Page, live_server_url):
    page.goto(live_server_url)
    expect(page.locator("#version-badge")).to_have_text("v10")
    ...
    expect(page.locator("#share-diagnostics")).to_be_visible()
    expect(page.locator("#repair-app")).to_be_visible()
