const CACHE = "inner-signal-v6";
const OFFLINE_CACHE = "inner-signal-offline-v1";
const SHELL = ["./", "styles.css", "enhancements.css", "offline.css", "mobile-fixes.css", "app.js", "manifest.webmanifest", "images/inner-signal-default.png", "images/stasya-knight-relaxation.png"];
